...
@property (nonatomic, readonly) float translationalVelocity;
@property (nonatomic, readonly) float rotationalVelocity;
...
- (BOOL)isDeviceModelXS SWIFT_WARN_UNUSED_RESULT;
...
- (void)retrieveScanPreviewWithPreviewAvailableCallback:(void (^ _Nonnull)(SCNNode * _Nonnull))previewAvailableCallback;
- (void)discardSessionData;
- (void)uploadDetailedMapWithProgressCallback:(void (^ _Nonnull)(float))progressCallback uploadCompleteCallback:(void (^ _Nonnull)(void))uploadCompleteCallback uploadFailedCallback:(void (^ _Nonnull)(NSString * _Nonnull))uploadFailedCallback;
- (void)dispose;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum LogLevel LOG_LEVEL;)
+ (enum LogLevel)LOG_LEVEL SWIFT_WARN_UNUSED_RESULT;
+ (void)setLOG_LEVEL:(enum LogLevel)value;
@end
...
typedef SWIFT_ENUM(NSInteger, ScanFeedback, closed) {
  ScanFeedbackFrameCaptured = 0,
};
