...
- (void)dispose;
- (void)planeDetectedWithNode:(SCNNode * _Nonnull)node anchor:(ARAnchor * _Nonnull)anchor;
- (void)planeUpdatedWithNode:(SCNNode * _Nonnull)node anchor:(ARAnchor * _Nonnull)anchor;
- (void)planeRemovedWithNode:(SCNNode * _Nonnull)node anchor:(ARAnchor * _Nonnull)anchor;
