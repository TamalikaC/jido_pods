...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger PLACE_ASSETS_INTERVAL;)
+ (NSInteger)PLACE_ASSETS_INTERVAL SWIFT_WARN_UNUSED_RESULT;
+ (void)setPLACE_ASSETS_INTERVAL:(NSInteger)value;
@end
